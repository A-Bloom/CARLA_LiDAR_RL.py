...
class CarEnv(MidEnv):
    ...
    def __init__(self):
        ...
        # Reward Options
        self.reward_distribution = [0, 0.5]  # [0 to 1 for speed, 0 to 1 for displacement]
        # (should add up to no more than 1 for normalization)
        self.speed_limit = 30  # in m/s, 14 m/s is ~31.3 mph, the speed reward is normalized by this number
        ...
        self.action_possibilities = 0  # 0 for steer, 1 for throttle forward and steer,
